export function EditorialPage() {
  return (
    <div style={{ marginTop: 16, paddingBottom: 40 }}>
      <div className="h-mono uppercase text-blue" style={{ fontSize: 10.5, letterSpacing: "0.3em" }}>
      ...
      >
        ...
        <div>
          <div className="h-mono uppercase text-blue" style={{ fontSize: 10, letterSpacing: "0.2em", marginBottom: 6, paddingBottom: 4, borderBottom: "1px solid #0e1a2b" }}>
            Figur 1 · effekt etter eierland
          </div>
          <svg viewBox="0 0 320 320" width="100%" style={{ display: "block" }}>
            <g fontFamily="JetBrains Mono, monospace" fontSize="9" fill="#0e1a2b">
              {[
                ...
                <g key={i} transform={`translate(0 ${i * 44})`}>
                  <text x="0" y="11" letterSpacing="0.06em">{d.label}</text>
                  <rect x="0" y="18" width={d.v * 1.55} height="14" fill={d.no ? "#0e1a2b" : "#1d49c7"} opacity={d.no ? 1 : 0.85}/>
                  <text x={d.v * 1.55 + 5} y="29" fontVariantNumeric="tabular-nums" fontSize="10" fontFamily="Fraunces">{d.v}</text>
                </g>
              ))}
            </g>
          </svg>
      ...
      >
        <div className="h-mono uppercase text-muted" style={{ fontSize: 10, letterSpacing: "0.18em" }}>
